class Quiz1 extends Phaser.Scene {
    ...
    preload() {
        this.bg = this.load.image("quiz_1", "assets/1.png");
    ...
    create() {
        ...
        let options = [
            "A) To increase the tax burden on the common man",
            "B) To simplify the indirect tax structure and reduce tax evasion",
            "C) To create inflation in the economy",
            "D) All of the above"
        ];
        let answer = 2;
        ...
        this.option4 = this.add.text(650, 630, options[3], {
            font: '24px Arial',
            fill: '#000',
            align: 'center',
        });
